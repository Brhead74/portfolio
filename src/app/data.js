...
export const data = [
    ...
    },
    {
        ...
        details: {
            fr: "Course infinie sous Unity, en équipe de quatre, pour le GMTK Game Jam 2025 sur le thème « loop ».",
            en: "An infinite racer built in Unity by a four-person team, for the 2025 GMTK Game Jam on the theme \"loop.\"",
        },
        longDescription: {
            fr: "Loops & Laps est un jeu de course infinie développé sous Unity, avec Karim Dion, Pier-Charles Martin et Normal Canard sous le nom d'équipe Wannabeez. On y incarne Laps, une petite souris mécanique prise dans une boucle avec Loops, le gardien de l'horloge — il faut manger un maximum de fromage avant de se faire rattraper.",
            en: "Loops & Laps is an infinite racing game built in Unity with Karim Dion, Pier-Charles Martin, and Normal Canard, under the team name Wannabeez. You play as Laps, a small mechanical mouse stuck in a loop with Loops, the guardian of the clock — the goal is to eat as much cheese as possible before getting caught.",
        },
        stack: ["Jeu", "UI", "VFX", "Unity"],
        link: "https://wannabeez.itch.io/loops-and-laps",
        tidbits: {
            fr: [
                "Fait pour le GMTK Game Jam 2025, sur le thème « loop ».",
                "Jouable au clavier — WASD ou ZQSD.",
                "Suivi en jeu du meilleur score et du meilleur tour.",
                "Jouable en ligne sur itch.io.",
            ],
            en: [
                "Made for the 2025 GMTK Game Jam, on the theme \"loop.\"",
                "Playable with WASD or ZQSD.",
                "Tracks your high score and best lap in-game.",
